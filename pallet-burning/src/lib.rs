...
impl<T: Config> Module<T> {
    pub fn _burn_tft(target: T::AccountId, amount: BalanceOf<T>, message: Vec<u8>) -> DispatchResult {
        ...
        // Desposit event
		Self::deposit_event(RawEvent::BurnTransactionCreated(target, amount, block, message));
